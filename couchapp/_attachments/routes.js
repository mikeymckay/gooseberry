...
Router = (function(_super) {
  ...
  Router.prototype.log = function(phoneNumber) {
    if (!Gooseberry.logView) {
      Gooseberry.logView = new LogView();
    }
    ...
    return Gooseberry.viewLogDB({
      ...
      success: (function(_this) {
        return function(result) {
          ...
          return Gooseberry.logView.render();
        };
      })(this)
    });
  };

  Router.prototype.viewRawResult = function(phoneNumber, questionSet) {
